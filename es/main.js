import { bgRed, bgBlue, bgGreen, bgYellow, bgOrange, bgSpringGreen, gradientGreen, bgBlack, gradientBlack, bgGroup } from './common/bg';
import { red, yellow, blue, green, orange, boldRed, boldBlue, boldGreen, boldOrange, boldYellow } from './common/general';
...
bgGroup(['test bg group 1', 'test bg group 2'], ['red', 'blue'], '121231');
